    ...
    <div class="container-fluid">
        ...
        <div class="dropdown">
            ...
            <a href="" class="" data-toggle="dropdown" aria-expanded="false">
                <img src="<?php echo $_SESSION['pic_user']; ?>" class="thumbnail rounded-circle" width="40">
                <span class="mx-2"><?php echo $_SESSION['fullname']; ?></span>
                <i class="fas fa-caret-down"></i>
            </a>
            <ul class="dropdown-menu p-3 dropdown-right bg-complement">
                <li class="p-2 pointer"><a id="my-data"> <i class="pe-2 fa fa-user"></i> Mis datos</a></li>
                <li class="p-2"><a href="#"> <i class="pe-2 fa fa-cog"></i>Preferencias</a></li>
                <hr>
                <li class="p-2"><a href="#" id="LogOut"> <i class="pe-2 fa fa-sign-out-alt"></i> Cerrar sesi&oacute;n</a></li>
            </ul>
        </div>
    </div>
</nav>
